  ...
  return (
    <div className='song'>
      ...
      <div className="song__bar">
        ...
        <Player duration={duration} audio={audio} randomIdFromArtist={randomIdFromArtist} randomId2FromArtist={randomId2FromArtist}/>

        <div>
          <p className='song__name single-item__2lines'>{name}</p>
          <p>{artist}</p>
        </div>
      </div>
    </div>
